...
/******/ 	var hotCurrentHash = "7fa693b99447392bae44"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	function init() {
	    ...
	    ReactDOM.render(React.createElement(Button, {Text: "hello"}), content);
	}
	module.exports = init;
...
/***/ function(module, exports) {
	...
	(function (ButtonActionTypes) {
	    ButtonActionTypes[ButtonActionTypes["NONE"] = 0] = "NONE";
	    ButtonActionTypes[ButtonActionTypes["CLICKED"] = 1] = "CLICKED";
	    ButtonActionTypes[ButtonActionTypes["ACTIVE"] = 2] = "ACTIVE";
	})(ButtonActionTypes || (ButtonActionTypes = {}));
	module.exports = ButtonActionTypes;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ButtonAction = (function () {
	    function ButtonAction(data, actionType) {
	        if (data === void 0) { data = {}; }
	        if (actionType === void 0) { actionType = ButtonActionTypes.NONE; }
	        this.Data = data;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ButtonStore = (function () {
	    ...
	    ButtonStore.prototype.Update = function (action) {
	        this.Publish(action.Data);
	    };
	    ButtonStore.prototype.Subscribe = function (subscriber) {
	        this._subscribers.push(subscriber);
	        return "";
	    };
	    ButtonStore.prototype.Publish = function (data) {
